...
export function FrontSide({ project }: { project: RepoModel }) {
  ...
  return (
    <div className="absolute inset-0 bg-[var(--color-card)] text-[var(--color-foreground)] px-4 py-4 rounded shadow overflow-auto backface-hidden">
      ...
      {project.repoUrl && (
        ...
        >
          ...
          <span className="text-sm">
            {projectDetaildata[lang].frontside.githublink}
          </span>
        </a>
      )}
      <div className="mt-4">
        <h3 className="font-semibold mb-1">
          {projectDetaildata[lang].frontside.techtitle}
        </h3>
